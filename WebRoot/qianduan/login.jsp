...
<body>
	...
	<div class="login_main">
		<div class="wrap">
			<form action="loginserverlet_q" class="list">
				<div class="login_title">密码登录</div>
				<input name="u_phonenum" type="text" class="name" placeholder="会员名/邮箱/手机号">
				<input name="u_password" type="password" class="password">
