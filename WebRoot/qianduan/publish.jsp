...
<html lang="en">
  ...
  <body>
    ...
    <div class="header">
        <div class="header_main wrap">
            ...
            <ul class="header_menu clearfix">
                <li><a href="qianduan/index1.jsp" target="_blank">首页</a></li>
                <li><a href="#">手机二手</a></li>
    ...
    <!-- 宝贝信息 -->
    <form action="AddServlet_f" method="post" enctype="multipart/form-data">
    <div class="bbxx wrap">
 ...
 <!--    	<div class="biaodan">
    	...
    	<div class="tutu"><span>宝贝图片：</span><input name="idleimg" type = "file"  onchange = "PreviewImage(this, 'imgHeadPhoto', 'divPreview')" /></div>
        <img id="xmTanImg"/>
        <div id="xmTanDiv"></div>
